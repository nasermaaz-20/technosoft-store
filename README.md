...
> **ملاحظة:** هذا المستودع للعرض والمحفظة (Portfolio). الكود المصدري عام — لا تضع أسرار الإنتاج هنا. راجع [SECURITY.md](./SECURITY.md) قبل النشر.
...
> في **الإنتاج** يتطلب مسار الإنشاء هيدر `x-admin-setup-secret` — راجع SECURITY.md.
...
**قبل رفع الكود على GitHub:** راجع [SECURITY.md](./SECURITY.md) وطبّق خطوات حماية موقع الزبون.
